...
## Notebooks
- [Aggregate transcripts by PM](https://github.com/GLAM-Workbench/pm-transcripts/blob/main/aggregate_transcripts.ipynb)
- [Harvest transcripts](https://github.com/GLAM-Workbench/pm-transcripts/blob/main/harvest_transcripts.ipynb)
- [Create an index to the harvested files](https://github.com/GLAM-Workbench/pm-transcripts/blob/main/index_and_analyse_transcript_metadata.ipynb)


## Associated datasets
- [GitHub - GLAM-Workbench/pm-transcripts-data · GitHub](https://github.com/wragge/pm-transcripts-data)
